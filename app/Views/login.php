                                ...
                                <div class="p-5">
                                    <div class="text-center mb-4">
                                        <div class="h3 text-gray-900">
                                            <i class="fa fa-plane"></i> Pariwisata <sup>:)</sup>
                                        </div>
                                        <sup>Aplikasi Untuk Mengelola Jumlah Pengunjung Wisata.</sup>
                                    ...
                                    <form class="user" method="POST" action="<?= base_url() ?>/login/auth">
                                        ...
                                        <input type="submit" value="Masuk" class="btn btn-info btn-user btn-block">
                                    </form>
                                </div>
                            </div>
                        </div>
